...
class ItalianNewArrivals extends Component {
  ...
  render() {
    return (
      <Wrapper style={{ background: "black"}}>
        <h1 className="sectionHeader">Le fragranze appena uscite</h1>
        {
          ...
          <Card key={index} style={{ width: "16rem" }} className="text-center">
            ...
            <Card.Body>
              ...
              <Button variant="light" style={{backgroundColor: "#355C7D", color: "white"}} onClick={this.onClick}>Scopri di più</Button>
            </Card.Body>
          </Card>))
...
export default withRouter(ItalianNewArrivals);