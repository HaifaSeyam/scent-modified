  ...
  return (
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ml-auto">
          <Nav.Item style={{ width: "8rem" }}><Link to="/" style={{color: "white"}}>الرئيسية</Link></Nav.Item>
          <Nav.Item style={{ width: "8rem" }}><Link to="/login" style={{color: "white"}}>تسجيل الدخول</Link></Nav.Item>
          <Nav.Item style={{ width: "8rem" }}><Link to="/register" style={{color: "white"}}>التسجيل</Link></Nav.Item>
        </Nav>
      </Navbar.Collapse>
    </Navbar>
  );
